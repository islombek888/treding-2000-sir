import { type MarketDataService, type Timeframe } from './marketDataService.js';
...
export declare class DecisionEngine {
     ...
     */
    static decide(dataService: MarketDataService, symbol: string, timeframe: Timeframe): Promise<ProbabilityResult | null>;
}
